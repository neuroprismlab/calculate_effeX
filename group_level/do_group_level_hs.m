...
data_filename = '/work/neuroprism/effect_size/data/subject_level/s_hcp_fc_noble_corr.mat';
...
for i = 1:length(tests)
    ...
    if test_type == 'r'
        ...
        results_file_prefix = [results_dir, 'testing_', S.study_info.dataset, '_', S.study_info.map, '_', S.study_info.test, '_', score_label, '_', condition];
            % TODO: remove 'test'
    end
    ...
    if test_type == 't'
        ...
        results_file_prefix = [results_dir, 'testing_', S.study_info.dataset, '_', S.study_info.map, '_', S.study_info.test, '_', condition1, '_', condition2];
    end
