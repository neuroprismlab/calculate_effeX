%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Effect maps created by [your name]
%
% Prereqs:
...
motion_dir = '/MOTIONPATH/'; % USER-DEFINED
scripts_dir = '/mridata2/home2/smn33/scripts/effect_size/helper_scripts/';
%scripts_dir = '/home/USERNAME/scripts/effect_size/';
results_dir = '/data_dustin/store3/training/effect_size/';

% motion paths - USER-DEFINED 
...
results_file_prefix = [results_dir,'dataset_map_test_x1_x2__v2']; % see naming convention

% script paths

data_loader_script_path = [scripts_dir,'data_loader']; % USER-DEFINED [this is only a placeholder and does not exist]
...
for do_pooling = pooling_params
    ...
    for motion_method_it = 1:length(motion_method_params)
        ...
        if ~strcmp(motion_method,'none')
            ...
            % Align motion and data by subject
