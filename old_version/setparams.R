...
data_dir <- '/Users/stephanienoble/Documents/data/mnt2'
...
full_dataset_filename <- paste0(local_effect_map_dir, 'full_data', skip_str)

effect_maps_precursor_filename <- paste0(local_effect_map_dir, 'effect_maps_precursor', skip_str)

# effect maps

effect_maps_filename <- paste0(local_effect_map_dir, 'effect_maps', skip_str)
