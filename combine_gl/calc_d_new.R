...
calc_d <- function(study, data, num_sdx_r2d = 2, output_file = paste0('/work/neuroprism/effect_size/data/combined_gl/intermediates/d_maps_', Sys.Date(), '.RData')) {
